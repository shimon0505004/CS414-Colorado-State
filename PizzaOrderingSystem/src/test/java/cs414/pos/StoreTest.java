...
public class StoreTest {
	...
	public void setUp() throws Exception {
		...
		testStore4.addEmployee(testName1, testLoginID1, testPassWord1);	
		testStore4.addEmployee(testName2, testLoginID2, testPassWord2);	
		testStore4.addEmployee(testName3, testLoginID3, testPassWord3);	
	...
	public void testAddEmployee() {
		...
		assertEquals(0, testStore3.getEmployeeSet().size());
		String test_Employee1 = testStore3.addEmployee(testName1, testLoginID1, testPassWord1);	
		assertEquals(1, testStore3.getEmployeeSet().size());
		String test_Employee2 = testStore3.addEmployee(testName2, testLoginID2, testPassWord2);	
		assertEquals(2, testStore3.getEmployeeSet().size());
		String test_Employee3 = testStore3.addEmployee(testName3, testLoginID3, testPassWord3);	
